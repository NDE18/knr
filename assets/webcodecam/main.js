				...
				resultFunction: function(text, imgSrc) {
					...
					$.post($link,
					 ...
					 function(data, status){
                         alertify.defaults.theme.ok = "btn w3-btn w3-blue btn-primary";
                         alertify.defaults.theme.cancel = "btn w3-btn w3-red btn-primary";
                         alertify.defaults.glossary.ok = "<i class='fa fa-fw fa-check-circle'></i> Valider";
                         alertify.defaults.glossary.cancel = "<i class='fa fa-fw fa-ban'></i> Refuter";
                         alertify.confirm("Validation du Code QR", data,
                             function(){
                             ...
                             function(){
                                 alertify.error('Validation annulée');
                             });
					 });
